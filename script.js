...
capitalizeName('victor hugo');

// Padding
const message = 'Go to gate 23!';
console.log(message.padStart(20, '+').padEnd(30, '+'));
console.log('Victor'.padStart(20, '+').padEnd(30, '+'));
...
console.log(maskCreditCard(5465475));
console.log(maskCreditCard(654376734765));
console.log(maskCreditCard(34565437345735488));
